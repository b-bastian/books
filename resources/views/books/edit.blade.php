                ...
                <div class="p-6 md:p-8 space-y-8">
                    ...
                    <form method="POST" action="{{ route('books.update', $book->id) }}" class="space-y-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <input name="isbn" value="{{ old('isbn', $book->isbn) }}" class="block w-full rounded-xl border-gray-300 dark:border-gray-700
                        ...
                        <div class="space-y-1">
                            ...
                            <input name="title" value="{{ old('title', $book->title) }}" class="block w-full rounded-xl border-gray-300 dark:border-gray-700
                                       bg-white/60 dark:bg-gray-900/50
                                       text-gray-900 dark:text-gray-100
                                       focus:border-indigo-500 focus:ring-indigo-500 transition">
                        </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <input name="pages" type="number" value="{{ old('pages', $book->pages) }}" class="block w-full rounded-xl border-gray-300 dark:border-gray-700
                                       bg-white/60 dark:bg-gray-900/50
                                       text-gray-900 dark:text-gray-100
                                       focus:border-indigo-500 focus:ring-indigo-500 transition">
                        </div>
